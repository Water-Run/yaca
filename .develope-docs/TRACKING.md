...
- Windows 客户端验证连续覆盖 XP SP3、Vista SP2、7 SP1、8、8.1、10 和 11；除 XP 外至少执行阻断发布的冒烟闭环。
- Debian 13 x86_64 作为现代 Linux 发布冒烟目标。
...
继续完成 00 号产品契约：确认 Windows 发布物的 CPU 架构策略。随后再确认 Linux 发行版与架构矩阵。
