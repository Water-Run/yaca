...
local function settle_successful_compaction(f, opened, compaction_id, manifest_digest)
    local request_record = {
        ...
        mode = "automatic",
        source_first_seq = 1,
        source_last_seq = opened.last_durable_sequence,
        source_digest = "source-digest",
        config_snapshot = "config-snapshot",
        model_snapshot_digest = "model-snapshot",
        prompt_bundle_digest = "prompt-snapshot",
        manifest_snapshot_id = "manifest-snapshot",
    ...
    local request_receipt = f.external_commit({ {
        ...
        fields = {
            ...
            sourceFirstSeq = "1",
            sourceLastSeq = tostring(opened.last_durable_sequence),
            sourceDigest = "source-digest",
            configSnapshot = "config-snapshot",
            modelSnapshot = "model-snapshot",
            promptSnapshot = "prompt-snapshot",
            manifestSnapshot = "manifest-snapshot",
            viewContextGeneration = tostring(opened.context_generation),
        },
